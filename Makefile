...
default: 
	g++ -I include/ src/glad.c src/test.cpp -lglfw3 -lGL -lX11 -lpthread -lXrandr -lXi -ldl -o test

window:
	g++ -I include/ src/glad.c src/helloWindow.cpp -lglfw3 -lGL -lX11 -lpthread -lXrandr -lXi -ldl -o window
